  ...
  render () {
    ...
    return (
      <div>
        <div className="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
          ...
          <div className="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
            <header className="demo-drawer-header">
              <img src={user.image} className="demo-avatar" />
              <div className="demo-avatar-dropdown">
                ...
                <ul className="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect" htmlFor="accbtn">
                  <li className="mdl-menu__item">{user.email}</li>
        ...
        <svg version="1.1" style={{ position: 'fixed', left: '-1000px', height: '-1000px' }}>
          <defs>
        ...
        <svg version="1.1" viewBox="0 0 500 250" style={{ position: 'fixed', left: '-1000px', height: '-1000px' }}>
          <defs>
            <g id="chart">
              <g id="Gridlines">
